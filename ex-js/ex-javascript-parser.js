  ...
  var result = {
    ...
    parse: function(input, startRule) {
            ...
            if (result2 !== null) {
              ...
              if (result4 !== null) {
                ...
                if (result5 !== null) {
                  result6 = parse___();
                  if (result6 !== null) {
                    result7 = parse_Elision();
                    result7 = result7 !== null ? result7 : "";
                    if (result7 !== null) {
                      result8 = parse___();
                      if (result8 !== null) {
                        result9 = parse_AssignmentExpression();
                        if (result9 !== null) {
                          result10 = parse_CommaEllipsis();
                          result10 = result10 !== null ? result10 : "";
                          if (result10 !== null) {
                            result4 = [result4, result5, result6, result7, result8, result9, result10];
                          } else {
                            result4 = null;
                            pos = pos2;
                          }
      ...
      function parse_Ellipsis() {
        ...
        pos0 = pos;
        result0 = (function(offset) { return macroType; })(pos) ? "" : null;
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
      ...
      function parse_CommaEllipsis() {
        var cacheKey = "CommaEllipsis@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
          ...
          if (result1 !== null) {
            ...
            if (result3 !== null) {
              ...
              if (result4 !== null) {
                result5 = parse___();
                if (result5 !== null) {
                  result6 = parse_PropertyAssignment();
                  if (result6 !== null) {
                    result7 = parse_CommaEllipsis();
                    result7 = result7 !== null ? result7 : "";
                    if (result7 !== null) {
      ...
      function parse_Expression() {
        ...
        result0 = parse_IdentifierName();
        if (result0 !== null) {
          result1 = (function(offset, head) { return metaVariables.statement.indexOf(head) >= 0;})(pos, result0) ? "" : null;
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result4 !== null) {
                result5 = parse_IdentifierName();
                if (result5 !== null) {
                  result6 = (function(offset, name) { return metaVariables.statement.indexOf(name) >= 0; })(pos, result5) ? "" : null;
                  if (result6 !== null) {
                    result7 = parse_Ellipsis();
                    result7 = result7 !== null ? result7 : "";
                    if (result7 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result3 !== null) {
              ...
              if (result4 !== null) {
                result5 = parse___();
                if (result5 !== null) {
                  result6 = parse_AssignmentExpressionNoIn();
                  if (result6 !== null) {
                    result7 = parse_CommaEllipsis();
                    result7 = result7 !== null ? result7 : "";
                    if (result7 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result3 !== null) {
              ...
              if (result4 !== null) {
                result5 = parse___();
                if (result5 !== null) {
                  result6 = parse_VariableDeclaration();
                  if (result6 !== null) {
                    result7 = parse_CommaEllipsis();
                    result7 = result7 !== null ? result7 : "";
                    if (result7 !== null) {
      ...
      function parse_MacroDefinition() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, type) { macroType = type; })(pos2, result0);
        }
        if (result0 === null) {
          pos = pos2;
        }
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    result6 = [];
                    pos2 = pos;
                    result7 = parse_MetaVariableDecralation();
                    if (result7 !== null) {
                      result8 = parse___();
                      if (result8 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, macroName, syntaxRules) { 
      ...
      function parse_MetaVariableDecralation() {
        ...
        pos0 = pos;
        pos1 = pos;
        if (input.substr(pos, 10) === "identifier") {
          result0 = "identifier";
          pos += 10;
        } else {
          result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, type, list) { 
          ...
          if (result0 !== null) {
            ...
            if (result1 !== null) {
              ...
              if (result2 !== null) {
                result3 = parse___();
                if (result3 !== null) {
                  result4 = parse_LiteralKeywordList();
                  if (result4 !== null) {
                    result5 = parse___();
                    if (result5 !== null) {
                      if (input.charCodeAt(pos) === 59) {
            ...
            if (result1 !== null) {
              ...
              if (result2 !== null) {
                ...
                if (result3 !== null) {
                  ...
                  if (result4 !== null) {
                    result5 = (function(offset, g_open, patterns, g_close) { return group[g_open].close === g_close; })(pos, result0, result2, result4) ? "" : null;
                    if (result5 !== null) {
                      result0 = [result0, result1, result2, result3, result4, result5];
                    } else {
                      result0 = null;
      ...
      function parse_CharacterStatement() {
        var cacheKey = "CharacterStatement@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_MacroExpression() {
        var cacheKey = "MacroExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        result0 = (function(offset) {})(pos) ? "" : null;
      ...
      function parse_MacroStatement() {
        var cacheKey = "MacroStatement@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_StatementInTemplate() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = (function(offset) { return macroType === "expression"; })(pos) ? "" : null;
        if (result0 !== null) {
          result1 = parse_AssignmentExpression();
          if (result1 !== null) {
            result0 = [result0, result1];
        ...
        if (result0 === null) {
          pos0 = pos;
          pos1 = pos;
          result0 = (function(offset) { return macroType === "statement"; })(pos) ? "" : null;
          if (result0 !== null) {
