  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "LiteralKeyword": parse_LiteralKeyword,
        "SyntaxRuleList": parse_SyntaxRuleList,
        "SyntaxRule": parse_SyntaxRule,
      ...
      function parse_ExpressionToken() {
        var cacheKey = "ExpressionToken@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return "expression"; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_StatementToken() {
        var cacheKey = "StatementToken@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return "statement"; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_ArgumentList() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = (function(offset) { return inTemplate; })(pos) ? null : "";
            if (result2 === null) {
              pos2 = pos;
              result2 = (function(offset) { return inTemplate; })(pos) ? "" : null;
              if (result2 !== null) {
      ...
      function parse_Expression() {
        ...
        result0 = parse_AssignmentExpression();
        if (result0 !== null) {
          result0 = (function(offset, exp) { lastExpr = exp; return exp; })(pos2, result0);
        }
        if (result0 === null) {
          pos = pos2;
        }
        if (result0 !== null) {
          ...
          if (result2 !== null) {
            ...
            if (result3 !== null) {
              result4 = (function(offset, comma) {
                            return comma[0] || inTemplate; })(pos, result3) ? "" : null;
              if (result4 !== null) {
            ...
            if (result3 !== null) {
              result3 = (function(offset, comma) { return comma[0] || " "; })(pos4, result3[0]);
            }
            if (result3 === null) {
              pos = pos4;
            }
            if (result3 !== null) {
              ...
              if (result4 !== null) {
                result5 = parse_AssignmentExpression();
                if (result5 !== null) {
                  result6 = (function(offset, delimiter, exp) {
                                if (delimiter) {
                                    return delimiter;
                                } else {
                                    lastExpr = exp;
          ...
          if (result2 !== null) {
            result2 = (function(offset, delimiter, exp) { return [delimiter, exp]; })(pos2, result2[1], result2[3]);
          }
          if (result2 === null) {
            pos = pos2;
          }
      ...
      function parse_MacroDefinition() {
        var cacheKey = "MacroDefinition@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    pos2 = pos;
                    pos3 = pos;
                    if (input.substr(pos, 11) === "identifier:") {
                      result6 = "identifier:";
                      pos += 11;
                    } else {
                      result6 = null;
                    ...
                    if (result6 !== null) {
                      ...
                      if (result7 !== null) {
                        pos2 = pos;
                        pos3 = pos;
                        if (input.substr(pos, 11) === "expression:") {
                          result8 = "expression:";
                          pos += 11;
                        } else {
                          result8 = null;
                          ...
                          if (result9 !== null) {
                            ...
                            if (result10 !== null) {
                              ...
                              if (result11 !== null) {
                                ...
                                if (result12 !== null) {
                                  result8 = [result8, result9, result10, result11, result12];
                                } else {
                                  result8 = null;
                                  pos = pos3;
                                }
                        ...
                        if (result8 !== null) {
                          ...
                          if (result9 !== null) {
                            pos2 = pos;
                            pos3 = pos;
                            if (input.substr(pos, 10) === "statement:") {
                              result10 = "statement:";
                              pos += 10;
                            } else {
                              result10 = null;
                              ...
                              if (result11 !== null) {
                                ...
                                if (result12 !== null) {
                                  ...
                                  if (result13 !== null) {
                                    ...
                                    if (result14 !== null) {
                                      result10 = [result10, result11, result12, result13, result14];
                                    } else {
                                      result10 = null;
                                      pos = pos3;
                                    }
                            ...
                            if (result10 !== null) {
                              result10 = (function(offset, stmts) {
                                                       statementNames = stmts; return stmts; })(pos2, result10[2]);
                            }
                            if (result10 === null) {
                              pos = pos2;
                            }
                            ...
                            if (result10 !== null) {
                              ...
                              if (result11 !== null) {
                                ...
                                if (result12 !== null) {
                                  result13 = parse___();
                                  if (result13 !== null) {
                                    result14 = parse_LiteralKeywordList();
                                    if (result14 !== null) {
                                      result15 = parse___();
                                      if (result15 !== null) {
                                        if (input.charCodeAt(pos) === 59) {
                                ...
                                if (result12 !== null) {
                                  result12 = (function(offset, literals) {
                                                            literalKeywordNames = literals; return literals; })(pos2, result12[2]);
                                }
                                if (result12 === null) {
                                  pos = pos2;
                                }
        ...
        if (result0 !== null) {
          result0 = (function(offset, type, macroName, idList, exprList, stmtList, literalList, syntaxRules) { 
                  ...
                  return { type: (type === "expression" ? "Expression" : "Statement" ) + "MacroDefinition",
                           ...
                           syntaxRules: syntaxRules }; })(pos0, result0[0], result0[2], result0[6], result0[8], result0[10], result0[12], result0[14]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_VariableList() {
        var cacheKey = "VariableList@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_LiteralKeywordList() {
        var cacheKey = "LiteralKeywordList@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_LiteralKeyword() {
        var cacheKey = "LiteralKeyword@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_SyntaxRuleList() {
        var cacheKey = "SyntaxRuleList@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_SyntaxRule();
        if (result0 !== null) {
          result1 = [];
          pos2 = pos;
          result2 = parse___();
          if (result2 !== null) {
            result3 = parse_SyntaxRule();
            if (result3 !== null) {
              result2 = [result2, result3];
            } else {
              result2 = null;
      ...
      function parse_SyntaxRule() {
        var cacheKey = "SyntaxRule@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  result4 = (function(offset) { inTemplate = true; })(pos2);
                }
                if (result4 === null) {
                  pos = pos2;
                }
                if (result4 !== null) {
                  result5 = parse___();
                  if (result5 !== null) {
                    result6 = parse_StatementInTemplate();
                    if (result6 !== null) {
                      if (input.charCodeAt(pos) === 125) {
                        result7 = "}";
                        pos++;
        ...
        if (result0 !== null) {
          result0 = (function(offset, pat, temp) {
                inTemplate = false;       
      ...
      function parse_Pattern() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, patterns) { return patterns; })(pos0, result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_SubPatternList() {
        var cacheKey = "SubPatternList@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_SubPattern() {
        var cacheKey = "SubPattern@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_PatternPunctuator() {
        ...
        if (result0 !== null) {
          result1 = (function(offset, puncs) { return puncs.join("") === "=>"; })(pos, result0) ? null : "";
          if (result1 !== null) {
            result0 = [result0, result1];
          } else {
            result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, puncs) { return puncs.join(""); })(pos0, result0[0]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_Punctuator() {
        ...
        result0 = parse_Punctuator1();
        if (result0 === null) {
          result0 = parse_Punctuator2();
        }
      ...
      function parse_Punctuator1() {
        var cacheKey = "Punctuator1@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_Punctuator2() {
        var cacheKey = "Punctuator2@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_StatementInTemplate() {
        var cacheKey = "StatementInTemplate@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_AssignmentExpression() {
        ...
        var pos0, pos1, pos2, pos3, pos4, pos5, pos6, pos7, pos8, pos9, pos10;
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return { type: "MacroName", name:"or"}; })(pos3);
        }
        if (result0 === null) {
          pos = pos3;
        }
        if (result0 !== null) {
          ...
          if (result1 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    ...
                    if (result6 !== null) {
                      result6 = (function(offset) { return { type: "String", data: "," }; })(pos8);
                    }
                    if (result6 === null) {
                      pos = pos8;
                    }
                    if (result6 !== null) {
                      ...
                      if (result7 !== null) {
                        ...
                        if (result8 !== null) {
                          ...
                          if (result10 !== null) {
                            ...
                            if (result11 !== null) {
                              result12 = parse___();
                              if (result12 !== null) {
                                result13 = parse_AssignmentExpression();
                                if (result13 !== null) {
                          ...
                          if (result9 !== null) {
                            ...
                            result10 = result10 !== null ? result10 : "";
                            if (result10 !== null) {
                              result11 = (function(offset, head, tail, ellipsis) { return !inTemplate && ellipsis; })(pos, result8, result9, result10) ? null : "";
                              if (result11 !== null) {
                        ...
                        if (result8 !== null) {
                          result8 = (function(offset, head, tail, ellipsis) { var elements = [head]; for (var i=0; i<tail.length; i++) { elements.push(tail[i][3]); } if (ellipsis) elements.push({ type: "Ellipsis" });  return { type: "Repetition", elements: elements, punctuationMark: "," }; })(pos8, result8[0], result8[1], result8[2]);
                        }
                        if (result8 === null) {
                          pos = pos8;
                        }
                ...
                if (result4 !== null) {
                  result4 = (function(offset, t0, t1, t2) { return [t0, t1, t2]; })(pos6, result4[0], result4[2], result4[4]);
                }
                if (result4 === null) {
                  pos = pos6;
                }
            ...
            if (result2 !== null) {
              result2 = (function(offset, t0) { return { type: "Paren", elements: t0 }; })(pos4, result2[2]);
            }
            if (result2 === null) {
              pos = pos4;
            }
            if (result2 !== null) {
              result2 = (function(offset, t0) { return [t0]; })(pos3, result2);
            }
            if (result2 === null) {
              pos = pos3;
            }
        ...
        if (result0 !== null) {
          result0 = (function(offset, t0, t1) { return [t0, t1]; })(pos1, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos1;
        }
        if (result0 !== null) {
          result0 = (function(offset, form) { return { type: "orMacroForm", inputForm: form }; })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
            ...
            if (result1 !== null) {
              ...
              if (result2 !== null) {
                ...
                if (result3 !== null) {
                  ...
                  result4 = parse_AssignmentExpression();
                  if (result4 !== null) {
                    result4 = (function(offset, t0) { return [t0]; })(pos6, result4);
                  }
                  if (result4 === null) {
                    pos = pos6;
                  }
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset) { return { type: "MacroName", name:"or"}; })(pos1);
            }
            if (result0 === null) {
              pos = pos1;
            }
      ...
      function parse_Statement() {
        ...
        var pos0, pos1, pos2, pos3, pos4, pos5, pos6, pos7, pos8, pos9, pos10, pos11, pos12, pos13, pos14;
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return { type: "MacroName", name:"let"}; })(pos3);
        }
        if (result0 === null) {
          pos = pos3;
        }
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  result4 = (function(offset) { return { type: "String", data: "var" }; })(pos9);
                }
                if (result4 === null) {
                  pos = pos9;
                }
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    ...
                    if (result6 !== null) {
                      result6 = (function(offset, name) { return { type: "Identifier", name: name }; })(pos13, result6);
                    }
                    if (result6 === null) {
                      pos = pos13;
                    }
                    if (result6 !== null) {
                      ...
                      if (result7 !== null) {
                        ...
                        if (result8 !== null) {
                          result8 = (function(offset) { return { type: "String", data: "=" }; })(pos13);
                        }
                        if (result8 === null) {
                          pos = pos13;
                        }
                    ...
                    if (result6 !== null) {
                      result6 = (function(offset, t0, t1, t2) { return [t0, t1, t2]; })(pos11, result6[0], result6[2], result6[4]);
                    }
                    if (result6 === null) {
                      pos = pos11;
                    }
                    if (result6 !== null) {
                      ...
                      if (result8 !== null) {
                        ...
                        if (result9 !== null) {
                          ...
                          if (result10 !== null) {
                            ...
                            pos13 = pos;
                            pos14 = pos;
                            result11 = parse_IdentifierName();
                            if (result11 !== null) {
                              result11 = (function(offset, name) { return { type: "Identifier", name: name }; })(pos14, result11);
                            }
                            if (result11 === null) {
                              pos = pos14;
                            }
                            if (result11 !== null) {
                              ...
                              if (result12 !== null) {
                                ...
                                if (result13 !== null) {
                                  result13 = (function(offset) { return { type: "String", data: "=" }; })(pos14);
                                }
                                if (result13 === null) {
                                  pos = pos14;
                                }
                                if (result13 !== null) {
                                  result14 = parse___();
                                  if (result14 !== null) {
                                    result15 = parse_AssignmentExpression();
                                    if (result15 !== null) {
                                      result11 = [result11, result12, result13, result14, result15];
                                    } else {
                                      result11 = null;
                                      pos = pos13;
                                    }
                            ...
                            if (result11 !== null) {
                              result11 = (function(offset, t0, t1, t2) { return [t0, t1, t2]; })(pos12, result11[0], result11[2], result11[4]);
                            }
                            if (result11 === null) {
                              pos = pos12;
                            }
                      ...
                      if (result7 !== null) {
                        ...
                        result8 = result8 !== null ? result8 : "";
                        if (result8 !== null) {
                          result9 = (function(offset, head, tail, ellipsis) { return !inTemplate && ellipsis; })(pos, result6, result7, result8) ? null : "";
                          if (result9 !== null) {
                    ...
                    if (result6 !== null) {
                      result6 = (function(offset, head, tail, ellipsis) { var elements = [head]; for (var i=0; i<tail.length; i++) { elements.push(tail[i][3]); } if (ellipsis) elements.push({ type: "Ellipsis" });  return { type: "Repetition", elements: elements, punctuationMark: "," }; })(pos9, result6[0], result6[1], result6[2]);
                    }
                    if (result6 === null) {
                      pos = pos9;
                    }
                ...
                if (result4 !== null) {
                  result4 = (function(offset, t0, t1) { return [t0, t1]; })(pos7, result4[0], result4[2]);
                }
                if (result4 === null) {
                  pos = pos7;
                }
            ...
            if (result2 !== null) {
              result2 = (function(offset, t0) { return { type: "Paren", elements: t0 }; })(pos5, result2[2]);
            }
            if (result2 === null) {
              pos = pos5;
            }
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    ...
                    if (result6 !== null) {
                      result6 = (function(offset, head, tail, ellipsis) { var elements = [head]; for (var i=0; i<tail.length; i++) { elements.push(tail[i][1]); } if (ellipsis) elements.push({ type: "Ellipsis" });  return { type: "Repetition", elements: elements, punctuationMark: "" }; })(pos8, result6[0], result6[1], result6[2]);
                    }
                    if (result6 === null) {
                      pos = pos8;
                    }
                    result6 = result6 !== null ? result6 : "";
                    if (result6 !== null) {
                      result6 = (function(offset, t0) { return [t0]; })(pos7, result6);
                    }
                    if (result6 === null) {
                      pos = pos7;
                    }
                ...
                if (result4 !== null) {
                  result4 = (function(offset, t0) { return { type: "Block", elements: t0 }; })(pos5, result4[2]);
                }
                if (result4 === null) {
                  pos = pos5;
                }
            ...
            if (result2 !== null) {
              result2 = (function(offset, t0, t1) { return [t0, t1]; })(pos3, result2[0], result2[2]);
            }
            if (result2 === null) {
              pos = pos3;
            }
        ...
        if (result0 !== null) {
          result0 = (function(offset, form) { return { type: "letMacroForm", inputForm: form }; })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            ...
            if (result1 !== null) {
              ...
              if (result2 !== null) {
                result2 = (function(offset) { return { type: "Paren", elements: "" }; })(pos5);
              }
              if (result2 === null) {
                pos = pos5;
              }
              if (result2 !== null) {
                ...
                if (result3 !== null) {
                  ...
                  if (result4 !== null) {
                    result4 = (function(offset) { return { type: "Block", elements: "" }; })(pos5);
                  }
                  if (result4 === null) {
                    pos = pos5;
                  }
